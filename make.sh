...
# Init out overlay
outputname="$romtypename-$outputtype-$sourcever-$date-ErfanGSI-p2109GSI"
...
sed -i "s/$bdisplay/$displayid2=Built\.by.\.pingmado\.with\.ErfanGSI\.Tools/" $systemdir/system/build.prop
